        ...
        .then((result) => {
            result.posts.forEach((item) => {
                ...
                if (commentsBox.length === 0) {
                    if (gifsBox.includes("career") === false) {
                    ...
                    if (gifsBox.includes("career") === false) {
                        ...
                        commentsBox.forEach((each) => {
                            ...
                            document
                                .getElementById(`comment-container-career-${postIdBox}`)
                        ...
                        document.getElementById(`comment-container-career-${postIdBox}`).style.alignItems =
                            "flex-start";
...
const textarea = document.querySelector("#new-post-career");
