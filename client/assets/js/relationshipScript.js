            ...
            result.posts.forEach((item) => {
                ...
                if (commentsBox.length === 0) {
                    if (gifsBox.includes("relationship") === false) {
                        ...
                        document
                            .getElementById("posts-container-relationships")
                    ...
                    if (gifsBox.includes("relationship") === false) {
                        ...
                        commentsBox.forEach((each) => {
                            ...
                            document.getElementById(`comment-container-relationships-${postIdBox}`).style.display =
                                "flex";
                            document
                                .getElementById(`comment-container-relationships-${postIdBox}`)
                        ...
                        document.getElementById(`comment-container-relationships-${postIdBox}`).style.flexDirection =
                            "column";
                        document.getElementById(`comment-container-relationships-${postIdBox}`).style.alignItems =
                            "flex-start";
