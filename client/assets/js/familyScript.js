...
function fetchPosts() {
    fetch("https://gotwins.herokuapp.com/api/posts/family")
                ...
                if (commentsBox.length === 0) {
                    if (gifsBox.includes("family") === false) {
                        ...
                        document.getElementById(`submit-btn-${postIdBox}`).addEventListener("click", (e) => {
                            ...
                            if (document.getElementById(`new-post-family-${postIdBox}`).value !== "") {
                                ...
                                let url = "https://gotwins.herokuapp.com/api/posts/family/";
                                url += postIdBox;
                                url += "/comments";
                    ...
                    if (gifsBox.includes("family") === false) {
                        ...
                        commentsBox.forEach((each) => {
                            ...
                            document
                                .getElementById(`comment-container-family-${postIdBox}`)
                        ...
                        document.getElementById(`comment-container-family-${postIdBox}`).style.alignItems =
                            "flex-start";
...
submitBtnFamily.addEventListener("click", (e) => {
    e.preventDefault();
